...
public class GridBuildingSystem : MonoBehaviour
{
    ...
    [SerializeField] private GridBuildingSystemUI gridBuildingSystemUI;
    [SerializeField] private LayerMask groundLayerMask;

    private void Start()
    {
        foreach (var buildingButton in gridBuildingSystemUI.BuildingButtons)
        {
    ...
    private void HandlePlacingOnClick()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            selectedPlaceableObject.transform.position = clickedNodeOrigin;
